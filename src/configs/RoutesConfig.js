...
export const publicRoutes = [
  {
    ...
    component: React.lazy(() => import("views/auth-views/authentication/home")),
  },
  {
    key: "chat",
  ...
  },
  {
    ...
    path: `${AUTH_PREFIX_PATH}/personal-details`,
    component: React.lazy(
      () => import("views/auth-views/authentication/personal-details")
    ),
  },
  {
    key: "education",
    path: `${AUTH_PREFIX_PATH}/education`,
    component: React.lazy(
      () => import("views/auth-views/authentication/education")
    ),
  },
  {
    key: "family-details",
    path: `${AUTH_PREFIX_PATH}/family-details`,
    component: React.lazy(
      () => import("views/auth-views/authentication/family-details")
    ),
  },
  {
    key: "horoscope",
    path: `${AUTH_PREFIX_PATH}/horoscope`,
    component: React.lazy(
      () => import("views/auth-views/authentication/horoscope")
    ),
  },
  {
    key: "face-detection",
    path: `${AUTH_PREFIX_PATH}/face-detection`,
    component: React.lazy(
      () => import("views/auth-views/authentication/face-detection")
    ),
  },
  {
    key: "upload-photo",
    path: `${AUTH_PREFIX_PATH}/upload-photo`,
    component: React.lazy(
      () => import("views/auth-views/authentication/upload-photo")
    ),
  },
  {
    key: "partners-preference",
    path: `${AUTH_PREFIX_PATH}/partners-preference`,
    component: React.lazy(
      () => import("views/auth-views/authentication/partners-preference")
    ),
  },
  {
    key: "profile-list",
    path: `${AUTH_PREFIX_PATH}/profile-list`,
    component: React.lazy(
      () => import("views/auth-views/authentication/profile-list")
    ),
  },
  {
    key: "profile-details",
    path: `${AUTH_PREFIX_PATH}/profile-details`,
    component: React.lazy(
      () => import("views/auth-views/authentication/profile-details")
    ),
  },
  {
    key: "profile-details-lock",
    path: `${AUTH_PREFIX_PATH}/profile-details-lock`,
    component: React.lazy(
      () => import("views/auth-views/authentication/profile-details-lock")
    ),
  },
  {
    key: "status-list",
    path: `${AUTH_PREFIX_PATH}/status-list`,
    component: React.lazy(
      () => import("views/auth-views/authentication/status-list")
    ),
  },
  {
    key: "profile-setting",
    path: `${AUTH_PREFIX_PATH}/profile-setting`,
    component: React.lazy(
      () => import("views/auth-views/authentication/profile-setting")
    ),
  },
  {
    key: "mehndi-artists",
