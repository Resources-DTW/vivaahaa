          ...
          <Row justify="center" gutter={[8, 8]}>
                  ...
                  <Row>
                    <Col span={24} lg={12}>
                      <div className="d-flex">
                        ...
                        <div className="text-dark text ml-1 mr-2">
                          +91 88888 XXXXX
                        </div>
                        <img
                          src={CheckIcon}
            ...
            <Col span={24} lg={20}>
              <Card className="profile_details_card">
                ...
                <div className="card_body premium_overlay">
                  <Row>
                    <Col span={24} lg={11}>
                      <Row>
                  ...
                  <div className="overlay">
                    <div className="center_text">
                      Only Premium Members can see all Details
                    </div>
                    <Link to="/auth/home" className="center_link">
                      Upgrade Now
                    </Link>
                  </div>
                </div>
...
export default ProfileDetailsLock;
